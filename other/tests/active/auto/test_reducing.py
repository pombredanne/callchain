...
class TestAutoReduceQ(unittest.TestCase, AQMixin, AReduceQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import areduceq
...
class TestAutoReducingQ(unittest.TestCase, AQMixin, AReducingQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import areducingq
...
class TestAutoMathQ(unittest.TestCase, AQMixin, AMathQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import amathq
        self.qclass = amathq
...
class TestAutoTruthQ(unittest.TestCase, AQMixin, ATruthQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import atruthq
        self.qclass = atruthq
...
class TestSyncReduceQ(unittest.TestCase, AQMixin, AReduceQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import sreduceq
...
class TestSyncReducingQ(unittest.TestCase, AQMixin, AReducingQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import sreducingq
...
class TestSyncMathQ(unittest.TestCase, AQMixin, AMathQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import smathq
        self.qclass = smathq
...
class TestSyncTruthQ(unittest.TestCase, AQMixin, ATruthQMixin):
    ...
    def setUp(self):
        from callchain.active.reducing import struthq
        self.qclass = struthq
